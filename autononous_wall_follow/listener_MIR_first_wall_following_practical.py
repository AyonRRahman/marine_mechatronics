...
def autonomous_control_wall_follow():
    ...
    global wait_after_explore
    # print(imu_data)
    # print(f'angle {angle_yaw_a0}')
    ####edit this
    global head_counter
    if not exploring_heading and wait_after_explore and pinger_confidence>=50:
        head_counter += 1
        if pinger_distance>1000:
            wait_after_explore=False
            head_counter=0
            print("done waiting after explore")
            ...
            write_thurster_values(controller_signal, stop_heading=True)
            
            # setOverrideRCIN(1500, 1500, 1500, 1500, 1500, 1500)

            print("waiting after explore")
            print(pinger_distance)
            return 
    ...
    # if False:
        ...
        if  sum(control_mode)>0 and set_mode[2] and arming and not exploring_heading:
            ...
            controller_signal = PID_control(
                            kp=kp,ki=ki,kd=kd,
                            state=current_state,
                            destination =[900,angle_yaw_a0 ,current_state[2]], #check this as well
                            floatability=floatability
                            )
