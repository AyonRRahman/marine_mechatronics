...
depth_control_mode = 3  #0 for not controlling depth, 1 for P, 2 for PI, 3 for PID
...
control_yaw_1 = 3.14/2 #the yaw at which we want to control
...
def trajectory_gen( t_final=20, mission_time=30, state_init = 0, state_final=1, dt=1/60): 
    ...
    # print(state_final)
    print(traj.shape)
    print(state_steady.shape)
    print(np.concatenate((traj, state_steady), axis =0).shape)
