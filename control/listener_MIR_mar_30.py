...
#for depth
control_depth_1 = 0.5 # the depth at which we want to control
depth_control_mode = 2 #0 for not controlling depth, 1 for P, 2 for PI, 3 for PID
...
control_yaw_1 = 3.14/3 #the yaw at which we want to control
...
traj, _ = trajectory_gen(t_final=20, mission_time=30, state_init=[0,0,depth_p0,0,0,angle_yaw_a0], state_final=[0,0,control_depth_1, 0,0,control_yaw_1])
