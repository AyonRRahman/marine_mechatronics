...
def OdoCallback(data):
    ...
    pose_bag.write(topic='yaw_control_pose', msg=angle)
    ...
    if yaw_control_mode!=0:
        control_bag.write(topic='yaw_control', msg=vel)
...
def PressureCallback(data):
    ...
    depth = Int16()
    depth.data = depth_wrt_startup
    pose_bag.write(topic='depth', msg = depth)
    ...
    if depth_control_mode!=0:
        ...
        control_bag.write(topic='depth_control', msg=vel)
